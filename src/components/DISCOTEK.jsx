        ...
        <div className="DISCOTEK">
            ...
            <div className="flex-port">
                ...
                <div className="port-text">
                    ...
                    <p>This project helped me expand my knowledge of backend and API practices and was my first piece of work with databases and API integration
                         which could be considered a full stack project
                    </p>
